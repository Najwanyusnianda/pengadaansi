            ...
            <form class="form-horizontal" method="POST" action="{{route('permintaan.store')}}">
                    <div class="card-body ml-3 ">
                        ...
                        <div class="form-group row  ">
                            <label for="form_kode" class="col-sm-2 col-form-label">Nomor Form</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="form_kode" name="form_kode" placeholder="" value="{{old('form_kode')}}">
                            </div>
                        </div>
                        <div class="form-group row ">
                            <label for="dateForm" class="col-sm-2  col-form-label">Tanggal Buat Form</label>
                            <div class="col-md-4">
                                <input type="date" class="form-control" id="date_Form" name="date_Form" placeholder="" value="{{old('date_form')}}">
                            </div>
                        </div>
                        <div class="form-group row ">
                            <label for="date_start" class="col-sm-2  col-form-label">Jangka Waktu Pelaksanaan</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row ">
                            <label for="SubKomponen" class="col-sm-2  col-form-label">Sub Komponen</label>
                            <div class="col-md-8">
                         ...
                         <div class="form-group row ">
                            <label for="GrupAkun" class="col-sm-2  col-form-label">Grup Akun</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <label for="jenis_pengadaan" class="col-sm-2  col-form-label">Select</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row ">
                            <label for="JudulPermintaan" class="col-sm-2  col-form-label">Judul Permintaan</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row ">
                            <label for="JumlahAnggaran" class="col-sm-2  col-form-label">Jumlah Anggaran</label>
                            <div class="col-md-8">
